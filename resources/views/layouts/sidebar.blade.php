...
<aside id="sidebar"
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/" class="flex items-center gap-3" aria-label="RumahKas">
            <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-brand-500 text-white shadow-theme-xs">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="m4 10 8-6 8 6v9a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-9Z" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/><path d="M8 14h8M9.5 17h5" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>
            </span>
            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen" class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">Rumah<span class="text-brand-500">Kas</span></span>
        </a>
    </div>
