...
class MenuHelper
{
    ...
    public static function getMenuGroups()
    {
        return [
            ...
            [
                'title' => 'Keuangan',
                'items' => array_values(array_filter(self::getMainNavItems(), fn ($item) => $item['path'] !== '/'))
            ],
            [
                'title' => 'Produktivitas',
                'items' => [[
    ...
    {
        $icons = [
            'transactions' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M6.5 3.5h11a1.5 1.5 0 0 1 1.5 1.5v14l-2.3-1.4-2.3 1.4-2.4-1.4L9.6 19l-2.3-1.4L5 19V5a1.5 1.5 0 0 1 1.5-1.5Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M8.5 8h7M8.5 11.5h7M8.5 15h4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',

            'wallet' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M4 7.25A2.25 2.25 0 0 1 6.25 5h11.5A2.25 2.25 0 0 1 20 7.25v10.5A2.25 2.25 0 0 1 17.75 20H6.25A2.25 2.25 0 0 1 4 17.75V7.25Z" stroke="currentColor" stroke-width="1.6"/><path d="M4.5 8h13.25A2.25 2.25 0 0 1 20 10.25V15h-5.25a2.75 2.75 0 1 1 0-5.5H20M15 12.25h.01" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',

            'budget' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 3.5a8.5 8.5 0 1 0 8.5 8.5H12V3.5Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M15 3.9A8.52 8.52 0 0 1 20.1 9H15V3.9Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/></svg>',

            'target' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="11" cy="13" r="7.5" stroke="currentColor" stroke-width="1.6"/><circle cx="11" cy="13" r="3.5" stroke="currentColor" stroke-width="1.6"/><path d="m13.5 10.5 6-6m0 0v4m0-4h-4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>',

            'report' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M6 3.5h9l3 3v14H6v-17Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M15 3.5v3h3M9 16v-3m3 3V9m3 7v-5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',

            'tag' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M4 5.5v5.8L12.7 20l7.3-7.3L11.3 4H5.5A1.5 1.5 0 0 0 4 5.5Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><circle cx="8" cy="8" r="1.25" fill="currentColor"/></svg>',

            'backup' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M7.5 18.5H6a3.5 3.5 0 0 1-.5-6.96A6.5 6.5 0 0 1 18.2 10a4.25 4.25 0 0 1-.7 8.5H16" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M12 11v9m0-9-3 3m3-3 3 3" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>',

            'settings' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.6"/><path d="M19.1 13.5a7.4 7.4 0 0 0 0-3l1.6-1.25-2-3.5-2 .8a7.7 7.7 0 0 0-2.6-1.5L13.8 3h-4l-.3 2.05a7.7 7.7 0 0 0-2.6 1.5l-2-.8-2 3.5 1.6 1.25a7.4 7.4 0 0 0 0 3L2.9 14.75l2 3.5 2-.8a7.7 7.7 0 0 0 2.6 1.5L9.8 21h4l.3-2.05a7.7 7.7 0 0 0 2.6-1.5l2 .8 2-3.5-1.6-1.25Z" stroke="currentColor" stroke-width="1.35" stroke-linejoin="round"/></svg>',

            'habit' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M18.5 8A7.5 7.5 0 1 0 19 15.2M18.5 8V3.8M18.5 8h-4.2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/><path d="m8.5 12 2.2 2.2 4.8-5" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>',
